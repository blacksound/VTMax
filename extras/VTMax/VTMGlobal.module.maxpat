...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 612.0, 132.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "deferlow"
								}
...
,
									"patching_rect" : [ 329.75, 132.0, 127.0, 22.0 ],
...
,
									"patching_rect" : [ 329.75, 67.0, 133.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 329.75, 39.0, 169.0, 22.0 ],
									"style" : "",
									"text" : "route newScene"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 329.75, 174.0, 35.0, 22.0 ],
									"style" : "",
									"text" : "shell"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 529.75, 39.0, 117.0, 22.0 ],
									"style" : "",
									"text" : "prepend findScenes"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 98.0, 117.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 48.0, 117.0, 22.0 ],
									"style" : "",
									"text" : "NakedScriptCanvas",
									"varname" : "coreCanvas"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 329.75, 98.0, 301.25, 22.0 ],
									"saved_object_attributes" : 									{
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 148.25, 254.0, 30.0, 30.0 ],
													"style" : ""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 148.25, 201.0, 59.0, 22.0 ],
													"style" : "",
													"text" : "tosymbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 148.25, 173.0, 133.0, 22.0 ],
													"style" : "",
													"text" : "sprintf %smisc/Scener/"
												}
...
,
									"patching_rect" : [ 529.75, 9.0, 114.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 329.75, 12.0, 97.0, 22.0 ],
									"style" : "",
									"text" : "r sceneManager"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 489.25, 93.0, 339.25, 93.0 ],
									"source" : [ "obj-15", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-81", 0 ],
									"midpoints" : [ 621.5, 164.0, 731.0, 164.0, 731.0, 93.0, 339.25, 93.0 ],
									"source" : [ "obj-2", 0 ]
								}
...
,
					"patching_rect" : [ 6.0, 646.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"name" : "SpatMethodTest.core.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/VTMax/misc/Scener/SpatMethodTest",
				"patcherrelativepath" : "../../misc/Scener/SpatMethodTest",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
