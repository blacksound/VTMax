...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 826.0, 79.0, 22.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"gradient" : 1,
					"hint" : "VTLydserverProxy.model VTLydserver",
					"id" : "obj-4",
					"maxclass" : "message",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.0, 734.0, 62.0, 22.0 ],
					"text" : "Lydserver Proxy",
					"textcolor" : [ 0.843137254901961, 0.784313725490196, 0.525490196078431, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.333333313465118, 734.0, 51.0, 22.0 ],
					"text" : "Scene Cores",
					"textcolor" : [ 0.843137254901961, 0.784313725490196, 0.525490196078431, 1.0 ],
					"textjustification" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 167.0, 166.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 108.0, 166.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 167.0, 252.0, 51.0, 22.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 167.0, 224.0, 35.0, 22.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 108.0, 252.0, 51.0, 22.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 108.0, 224.0, 35.0, 22.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 224.0, 35.0, 22.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 167.0, 283.5, 147.0, 35.0 ],
...
,
									"patching_rect" : [ 108.0, 326.0, 83.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 353.0, 142.0, 22.0 ],
...
,
					"patching_rect" : [ 6.0, 826.0, 49.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"gradient" : 1,
					"hint" : "VTMGlobal.model global",
					"id" : "obj-33",
					"maxclass" : "message",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 734.0, 31.0, 22.0 ],
					"text" : "Global",
					"textcolor" : [ 0.843137254901961, 0.784313725490196, 0.525490196078431, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"bgfillcolor_angle" : 270.0,
					"bgfillcolor_autogradient" : 0.0,
					"bgfillcolor_color" : [ 0.843137254901961, 0.784313725490196, 0.525490196078431, 0.0 ],
					"bgfillcolor_color1" : [ 1.0, 0.0, 0.097325, 1.0 ],
					"bgfillcolor_color2" : [ 0.685, 0.685, 0.685, 1.0 ],
					"bgfillcolor_proportion" : 0.39,
					"bgfillcolor_type" : "color",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 761.0, 154.0, 33.0 ],
...
,
					"patching_rect" : [ 6.0, 853.0, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 81.0, 853.0, 56.0, 22.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 1.0, 170.0, 723.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 761.0, 154.0, 58.0 ],
					"proportion" : 0.5,
					"rounded" : 10
				}
